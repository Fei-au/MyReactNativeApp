...
function PermissionsPage({ navigation } : any): React.JSX.Element{
  ...
  useEffect(() => {
    if (cameraPermissionStatus === 'granted' && microphonePermissionStatus === 'granted') navigation.replace('Login')
